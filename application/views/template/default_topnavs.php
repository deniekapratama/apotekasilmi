		...
		<nav>
			...
			<ul class="nav navbar-nav navbar-right">
				<li>
					...
					<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="<?php echo base_url('assets/images/avatar.png') ?>" alt="">Selamat Datang, <?= $user['name']; ?> <!-- <span class="fa fa-angle-down"></span> --></a>
